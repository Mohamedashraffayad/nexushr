    ...
    kb: [
      {
        ...
        response: "محرك رواتب NexusHR يحسب الضرائب والخصومات وصافي الراتب تلقائياً — استناداً إلى بيانات الحضور والقواعد المُهيَّأة ومتطلبات الامتثال المحلية. لا جداول بيانات، لا مطابقة يدوية. دورة الرواتب التى كانت تستغرق أياماً تنتهي عادةً في أقل من 5 دقائق.",
        actions: [
      ...
      },
      {
        ...
        response: "يتعامل NexusHR مع جميع أنواع الإجازات — السنوية والمرضية والطارئة وإجازة الأمومة/الأبوة والأنواع المخصصة التى تُهيِّؤها. تسير طلبات الإجازة والموافقات عليها عبر النظام، وتُحدَّث الأرصدة تلقائياً.",
        actions: [
          { label: "احجز عرضاً توضيحياً →", value: "demo", href: "#demo" },
          { label: "استعرض المميزات", value: "features_link", href: "#features" },
        ],
